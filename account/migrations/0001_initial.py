    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=11, unique=True, validators=[django.core.validators.RegexValidator('^0\\d{10}$', code='Invalid_phone', message='Enter a valid Nigerian number')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('landmark', models.CharField(help_text='Optional landmark near the address', max_length=255)),
